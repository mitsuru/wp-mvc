...
class MvcFormTagsHelper extends MvcHelper {
	...
	public static function input($field_name, $options=array()) {
		$defaults = array(
	...
	public static function text_input($field_name, $options=array()) {
		$defaults = array(
			'id' => self::input_id($field_name),
			'name' => self::input_name($field_name),
			'type' => 'text'
	...
	public static function textarea_input($field_name, $options=array()) {
		$defaults = array(
			'id' => self::input_id($field_name),
			'name' => self::input_name($field_name)
		);
	...
	public static function checkbox_input($field_name, $options=array()) {
		$defaults = array(
			'id' => self::input_id($field_name),
			'name' => self::input_name($field_name),
			'type' => 'checkbox',
	...
	public static function hidden_input($field_name, $options=array()) {
		$defaults = array(
			'id' => self::input_id($field_name),
			'name' => self::input_name($field_name),
			'type' => 'hidden'
	...
	public static function select_input($field_name, $options=array()) {
		$html = self::before_input($field_name, $options);
	...
	public static function select_tag($field_name, $options=array()) {
		$defaults = array(
			'id' => self::input_id($field_name),
			'name' => self::input_name($field_name),
			'empty' => false,
	...
	public static function button($text, $options=array()) {
		$defaults = array(
	...
	private static function before_input($field_name, $options) {
		$defaults = array(
			'before' => ''
		);
		$options = array_merge($defaults, $options);
	...
	private static function after_input($field_name, $options) {
		$defaults = array(
			'after' => ''
		);
		$options = array_merge($defaults, $options);
	...
	private static function input_id($field_name) {
		return $field_name;
	}
	
	private static function input_name($field_name) {
		return $field_name;
	}
